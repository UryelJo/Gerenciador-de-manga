        ...
        <div class="col" style="width: 50%; justify-content: space-evenly">
            ...
            <div class="col justify-center" style="width: 100%; height: 250px; gap:20px">
                ...
                <div class="row" style="justify-content: space-evenly">
                    <div class="col">
                        <labe. for="input-quantidade">Quantidade Requisitada</label>
                ...
                <div class="row" style="justify-content: space-evenly">
                    ...
                    <div class="col">
                        ...
                        foreach ($listaDeAutores as $autor) {
                            echo "<div class='row align-center'>
                            <input type='radio' id='input-autor-" . htmlspecialchars($autor->getId()) . "' " . ($autor->getId() == $mangaSelecionado->getAutorId() ? 'checked="true"' : '') . " name='input-autor' value='" . htmlspecialchars($autor->getId()) . "'>
        ...
        <div class="col align-center" style="width: 50%; justify-content: space-evenly">
            <div class="col justify-center" style="width: 100%; height: 400px; gap:20px">
                <div class="col">
                    ...
                    <input id="input-resumo" value="<?php echo htmlspecialchars($mangaSelecionado->getDescricao(), ENT_QUOTES, 'UTF-8'); ?>" name="input-resumo" type="text">
                </div>
                <div class="col" style="height:100%">
                    <label for="input-descricao">Descrição</label>
                    <textarea id="input-descricao" name="input-descricao" style="height: 100%"><?php echo $mangaSelecionado->getResumo(); ?></textarea>
                </div>
            </div>
