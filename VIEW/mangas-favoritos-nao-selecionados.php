...
<body>
    <div class="container mt-4" style="height: 80%; overflow-y: auto">
        <button class="btn btn-primary mb-3" onclick="window.location.replace('favoritos.php')">Voltar</button>
        ...
        if ($mangas == null) {
            ...
            foreach($mangas as $manga) {
                ...
                echo '<td><button class="btn btn-success" onclick="document.location.href=\'http://localhost:8080/Gerenciador-de-manga/VIEW/cadastrar-favorito.php?id=' . $manga->getId() . '\'">Adicionar</button></td>';
                echo '</tr>';
            }
            echo '</tbody>';
            echo '</table>';
